...
public class RegisterPatient extends javax.swing.JFrame {
    ...
    private void registerPatientMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registerPatientMouseClicked
        ...
        Entities.Patient patient = new Entities.Patient(nameField.getText(), surnameField.getText(), dobField.getText(), addressField.getText(), postCodeField.getText(), emailField.getText(),passwordField.getPassword());
        PatientLogin plogin = new PatientLogin();
        plogin.setVisible(true);
